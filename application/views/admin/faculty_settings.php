...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue" >Faculty Settings</h4>
					...
					<div			<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="faculty_name" id="faculty_name" value="">
										</div>
									</div>
										<div class="col-md-4">
										<div class="form-group">
											<label >Faculty Proffession<span style="color:red">*</span> </label>
											<input type="text" class="form-control" name="faculty_prof" id="faculty_prof" value="">
										</div>
									</div>
										...
										<div class="form-group">
											...
											<textarea  class="form-control" name="faculty_desc" id="faculty_desc" value=""></textarea>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control " name="faculty_qual" id="faculty_qual" value="">
										</div>
						...
						<button class="btn btn-outline-info pull-right  save_faculty" type="button" rel="0"> Save </button>
				      </div>
				     </div>
					</form>
					</div>
			...
			<table class="data-table stripe hover nowrap">
							<thead>
								<tr>
									<th class="table-plus ">Faculty Name</th>
									<th>Faculty Proffession</th>
							...
							<?php  if(isset($faculties)){
								...
								?>
								<tr>
									<td class="table-plus"><?php echo $f["web_faculty_name"];?></td>
									<td><?php echo ucfirst($f["web_faculty_prof"]);?></td>
									<td><?php echo ucfirst($f["campus"]);?></td>
									<td><?php echo $f["web_faculty_qual"];?></td>
									<td><?php echo $f["web_faculty_image"];?></td>
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-left">
												<a class="dropdown-item" href="<?php echo base_url();?>home_settings/edit_faculty_settings/<?php echo $f["web_faculty_id"]; ?>" rel=""><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item delete_faculty" href="#" rel="<?php echo $f["web_faculty_id"];?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
