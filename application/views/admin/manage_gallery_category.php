...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue" >Manage  Gallery Category</h4>
			...
			<table class="data-table stripe hover nowrap">
							...
							<?php foreach($gallery_category as $g){?>
								<tr>
									...
									<td><?php echo $g["web_gallery_cat_image"]?></td>
									<td><?php echo $g["web_gallery_cat_caption"]?></td>
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-left">
												<a class="dropdown-item" href="<?php echo base_url();?>gallery_settings/edit_gallery_category_settings/<?php echo $g["web_gallery_cat_id"]?>" rel=""><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item delete_gallery" href="#" rel="<?php echo $g["web_gallery_cat_id"]?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
	...
	var sizeLimit= 1024*10;
	 if(sizeInMb > sizeLimit){
		 ...
		 $("#news_image").val("");
       	...
       	var id= $(this).attr("rel");
				$("form#gallery").attr("action", "<?=base_url()?>gallery_settings/delete_gallery_category/"+id);
            $("form#gallery").submit();
    }
