...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue" >Edit Department Settings</h4>
					...
					<div			<div class="row">
									<div class="col-md-4">
									<?php 	foreach($department_details as $d) ?>
										<div class="form-group">
											<label >Department Name <span style="color:red">*</span></label>
											<input type="text" class="form-control" name="dept_name" id="dept_name" value="<?php echo $d["web_dept_name"];?>">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
								...
								?>
								<option value="<?php echo $i["web_inst_id"];?>" <?php if($d["web_inst_dept_ref_id"]==$i["web_inst_id"]) { echo "selected";}?>><?php echo $i["web_inst_name"];?></option>
										<?php }
									}
							?>	
											</select>
										...
										<div class="form-group">
											...
											<option value="1" <?php if($d["web_dept_course_mode"]==1) { echo "selected";}?>> Course Display</option>
											<option value="2" <?php if($d["web_dept_course_mode"]==2) { echo "selected";}?>> Enquiry Display</option>
								...
								<div class="row">
									...
									<?php if($d["web_dept_image"]!=""){?>
										<div class="col-md-4">
										<div class="form-group">
											<label >Saved Image </label><br/>
											<a   href="<?php echo base_url();?>department_images/<?php echo $d["web_dept_image"]?>" target="_blank"class="" ><?php echo $d["web_dept_image"]?></a>
										</div>
									</div>
									<?php 
									}
						...
						<button class="btn btn-outline-info pull-right  save_dept" type="button" rel="<?php echo $d["web_dept_id"];?>"> Update </button>
				      </div>
				     </div>
					</form>
					</div>
...
$.ajax({
		...
		;
       	...
       	var id= $(this).attr("rel");
				$("form#dept").attr("action", "<?=base_url()?>course_settings/delete_institute/"+id);
            $("form#dept").submit();
    }
