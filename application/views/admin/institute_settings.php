...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue" >Institute Settings</h4>
					...
					<div			<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="inst_name" id="inst_name" value="">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label >Institute Address </label>
											<textarea class="form-control" name="inst_address" id="inst_address" value=""></textarea>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label >Institute City </label>
											<input type="text" class="form-control" name="inst_city" id="inst_city" value="">
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="inst_state" id="inst_state" value="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label >Institute Pincode </label>
											<input type="text" class="form-control" name="inst_zipcode" id="inst_zipcode" value="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
						...
						<button class="btn btn-outline-info pull-right  save_inst" type="button" rel="0"> Save </button>
				      </div>
				     </div>
					</form>
					</div>
			...
			<table class="data-table stripe hover nowrap">
							<thead>
								<tr>
									<th class="table-plus ">Institute Name</th>
							...
							<?php  if(isset($institutions)){
								...
								?>
								<tr>
									<td class="table-plus"><?php echo $i["web_inst_name"];?></td>
									<td><?php echo ucfirst($i["web_inst_address"].",<br/>".$i["web_inst_city"].", ".$i["web_inst_state"]." - ".$i["web_inst_zip"]);?></td>
									<td><?php echo $i["web_inst_contact"];?></td>
									<td><?php echo $i["web_inst_email"];?></td>
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-left">
												<a class="dropdown-item" href="<?php echo base_url();?>settings/edit_institute_settings/<?php echo $i["web_inst_id"]; ?>" rel="<?php echo $i["web_inst_id"];?>"><i class="fa fa-pencil"></i> Edit</a>
												<!--<a class="dropdown-item delete_inst" href="#" rel="<?php echo $i["web_inst_id"];?>"><i class="fa fa-trash"></i> Delete</a>-->
											</div>
										</div>
									</td>
								</tr>
...
$.ajax({
		...
		;
       	...
       	var id= $(this).attr("rel");
				$("form#institute").attr("action", "<?=base_url()?>settings/delete_institute/"+id);
            $("form#institute").submit();
    }
