...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<?php foreach($gallery_details as $g);?>
					<div			<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label >Gallery Category Name <span style="color:red">*</span></label>
											<input type="text" class="form-control" name="gallery_cat_name" id="gallery_cat_name" value="<?php echo $g["web_gallery_category_name"]?>">
										</div>
									</div>
											<div class="col-md-6">
										<div class="form-group">
								...
								?>
												<option value="<?php echo $i["web_inst_id"]?>" <?php if($g["web_gallery_inst_id"]==$i["web_inst_id"]){ echo "Selected";}?>><?php echo $i["web_inst_name"]?></option>
												<?php }
												}?>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control " name="gallery_image_caption" id="gallery_image_caption" value="<?php echo $g["web_gallery_image_caption"]?>">
										</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											<label >Saved Gallery Image </label>
													<a href="<?php echo base_url();?>gallery_images/<?php echo $g["web_gallery_main_image"]?>" target="_blank"class="" ><?php echo $g["web_gallery_main_image"]?></a>
						...
						<button class="btn btn-outline-info pull-right  save_gallery" type="button" rel="<?php echo $g["web_gallery_id"]?>"> Update </button>
				      </div>
				     </div>
					</form>
					</div>
