...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue" >Edit Course Settings</h4>
							<p class="mb-30 font-14"></p>
						</div>
						
					</div>
					<form id="course" action="" method="post" enctype="multipart/form-data">
									<?php foreach($course_details as $cd);?>
								<div class="row">
											<div class="col-md-8">
										<div class="form-group">
											<label >Institute</label>
												...
												<option value="<?php echo $i["web_inst_id"];?>" <?php if($i["web_inst_id"]==$cd["web_inst_id"]){ echo "selected";}?>><?php echo $i["web_inst_name"];?></option>
												<?php }?>
					...
					<div			 class="row">
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="course_number" id="course_number" value="<?php echo $cd["web_course_number"]?>">
										</div>
									</div>
										<div class="col-md-8">
										<div class="form-group">
											<label >Course Name <span style="color:red">*</span> </label>
											<input type="text" class="form-control" name="course_name" id="course_name" value="<?php echo $cd["web_course_name"]?>">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="course_abbrv" id="course_abbrv" value="<?php echo $cd["web_course_abbrv"]?>">
										</div>
									</div>
											<div class="col-md-4">
										<div class="form-group">
										<?php $departments = $this->admin_model->get_departments($cd["web_inst_id"]);?>
											<label >Course Department<span style="color:red">*</span></label>
												...
												<option value="<?php echo $d["web_dept_id"]?>" <?php if($cd["web_course_dept_ref_id"]==$d["web_dept_id"]){ echo "selected";}?>><?php echo $d["web_dept_name"]?></option>
												<?php }?>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label >Course Duration<span style="color:red">*</span></label>
												...
												<?php foreach($course_duration as $cdr){?>
												<option value="<?php echo $cdr["web_sub_cat_id"]?>" <?php if($cd["web_course_duration"]==$cdr["web_sub_cat_id"]){ echo "selected";}?>><?php echo $cdr["web_sub_cat_name"]?></option>
												<?php }?>
								...
								<div class="col-md-4">
										<div class="form-group">
											<label >Mode of Training<span style="color:red">*</span></label>
												...
												<option value="<?php echo $md["web_sub_cat_id"]?>" <?php if($cd["web_mode_of_training"]==$md["web_sub_cat_id"]){ echo "selected";}?>><?php echo $md["web_sub_cat_name"]?></option>
												<?php }?>
										...
										<div class="form-group">
											...
											<option value="1"  <?php if($cd["web_course_disp_mode"]==1) { echo "selected";}?>> Course Display</option>
											<option value="2" <?php if($cd["web_course_disp_mode"]==2) { echo "selected";}?>> Enquiry Display</option>
								
											</select>
										</div>
									</div>
									<?php if($cd["web_course_image"]!=""){?>
										<div class="col-md-4">
										<div class="form-group">
											<label >Saved Image </label><br/>
											<a   href="<?php echo base_url();?>course_images/<?php echo $cd["web_course_image"]?>" target="_blank"class="" ><?php echo $cd["web_course_image"]?></a>
										</div>
									</div>
									<?php 
									}
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea class="textarea_editor form-control border-radius-0" name="course_desc" id="course_desc" value="<?php echo $cd["web_course_desc"]?>"><?php echo $cd["web_course_desc"]?></textarea>
										</div>
									</div>
								</div>
						...
						<button class="btn btn-outline-info pull-right  save_course" type="button" rel="<?php echo $cd["web_course_id"];?>"> Update </button>
				      </div>
				     </div>
					</form>
					</div>
