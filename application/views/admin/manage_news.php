...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue" >Manage News & Updates</h4>
					...
					<div			<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="news_head" id="news_head" value="">
										</div>
									</div>
											<div class="col-md-4">
										<div class="form-group">
											<label >News Category<span style="color:red">*</span></label>
												...
												<option value="<?php echo $nc["web_sub_cat_id"]?>"><?php echo $nc["web_sub_cat_name"]?></option>
												<?php }?>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control date-picker" name="news_date" id="news_date" value="">
										</div>
								...
								<div class="col-md-12">
										<div class="form-group">
											...
											<textarea class="textarea_editor form-control border-radius-0" name="news_details" id="news_details" value=""></textarea>
										</div>
									</div>
								</div>
						...
						<button class="btn btn-outline-info pull-right  save_news" type="button" rel="0"> Save </button>
				      </div>
				     </div>
					</form>
					</div>
			...
			<table class="data-table stripe hover nowrap">
							...
							<?php  if(isset($news)){
								foreach($news as $n){
									$image_thumb="";
									if($n["web_news_image"]!=""){
										$image=explode(".",$n["web_news_image"]);
										$image_thumb= $image[0]."_thumb.".$image[1];
									}
								?>
								<tr>
									<td class="table-plus"><?php echo $n["web_news_head"];?></td>
									<td><?php echo ucfirst($n["web_inst_name"]);?></td>
									<td><?php echo  date("d-m-Y",strtotime($n["web_news_date"]));?></td>
									<td><?php echo $n["web_news_image"];?></td>
									<td><?php echo $image_thumb;?></td>
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-left">
												<a class="dropdown-item" href="<?php echo base_url();?>home_settings/edit_news_settings/<?php echo $n["web_news_id"]; ?>" rel="<?php echo $n["web_news_id"];?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item delete_news" href="#" rel="<?php echo $n["web_news_id"];?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
