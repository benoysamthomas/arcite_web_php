...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue" >Manage Testimonials</h4>
			...
			<table class="data-table stripe hover nowrap">
							<thead>
								<tr>
									<th class="table-plus ">Testimonial Person</th>
									<th>Institute</th>
									<th>Image</th>
							...
							<?php  if(isset($testimonials)){
								...
								?>
								<tr>
									<td class="table-plus"><?php echo $t["web_testimonial_person"];?></td>
									<td><?php echo ucfirst($t["web_inst_name"]);?></td>
									<td><?php echo $t["web_testimonial_image"];?></td>
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-left">
												<a class="dropdown-item" href="<?php echo base_url();?>home_settings/edit_manage_testimonials/<?php echo $t["web_testimonial_id"]; ?>" rel=""><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item delete_testimonial" href="#" rel="<?php echo $t["web_testimonial_id"];?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
