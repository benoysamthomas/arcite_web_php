...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue" >User Settings</h4>
					...
					<form id="usr_settings" action="" method="post" enctype="multipart/form-data">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="user_fname" id="user_fname" value="">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label >Last Name<span style="color:red">*</span> </label>
											<input type="text" class="form-control" name="user_lname" id="user_lname" value="">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="password" class="form-control" Placeholder="" name="paswd" id="paswd" >
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="user_contact" id="user_contact" value="">
										</div>
						...
						<button class="btn btn-outline-info pull-right  save_user" type="button" rel="0"> Save </button>
				      </div>
				     </div>
					</form>
					</div>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item delete_user" href="#" rel="<?php echo $ud["web_user_id"];?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
  ...
  $(document).ready(
	function() {
            ...
            $('html,body').animate({
                    ...
                    'slow');
            return false;
        }else if ($.trim($("#paswd").val()) == "") {
					//alert("first");
            $("#paswd").css("border","1px solid #ff0000");
            $('html,body').animate({
                    scrollTop: $("#paswd").offset().top - 100},
                    'slow');
            return false;
