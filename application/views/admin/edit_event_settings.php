...
$this->session->unset_userdata('alert_status');
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form id="event" action="" method="post" enctype="multipart/form-data">
						<?php foreach($event_details as $e);?>
					<div			<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label >Event Name <span style="color:red">*</span></label>
											<input type="text" class="form-control" name="event_name" id="event_name" value="<?php echo $e["web_event_name"]?>">
										</div>
									</div>
										<div class="col-md-4">
										<div class="form-group">
											<label >Event Location<span style="color:red">*</span> </label>
											<input type="text" class="form-control" name="event_location" id="event_location" value="<?php echo $e["web_event_location"]?>">
										</div>
									</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control date-picker" name="event_date" id="event_date" value="<?php echo  date("d-m-Y",strtotime($e["web_event_date"]))?>">
										</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control " name="event_time" id="event_time" value="<?php echo $e["web_event_time"]?>">
										</div>
								...
								?>
												<option value="<?php echo $i["web_inst_id"]?>" <?php if($e["web_event_inst_id"]==$i["web_inst_id"]){ echo "selected";}?>><?php echo $i["web_inst_name"]?></option>
												<?php }
												}?>
								...
								<div class="col-md-4">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<a href="<?php echo base_url();?>event_images/<?php echo $e["web_event_image"]?>" target="_blank"class="" ><?php echo $e["web_event_image"]?></a>
										</div>
									</div>
									<?php }?>
									<!--<div class="col-md-3">
						...
						<button class="btn btn-outline-info pull-right  save_event" type="button" rel="<?php echo $e["web_event_id"];?>"> Update </button>
				      </div>
				     </div>
					</form>
					</div>
