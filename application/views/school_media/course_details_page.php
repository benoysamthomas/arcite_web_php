            ...
            <div class="kingster-breadcrumbs" style="padding-top: 12px ;padding-bottom: 60px ;">
                <div class="kingster-breadcrumbs-container kingster-container">
                    <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to ARCITE" href="<?php echo base_url(); ?>school_technical_edu/home" class="home"><span property="name">Home</span></a>
                        ...
                        </span>&gt;<!--<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Accounting." href="<?php echo base_url(); ?>school_technical_edu/course_search" class="post post-page"><span property="name"><?php echo $ci['web_dept_name']?></span></a>
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-image-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-center-align">
													...
													<?php } else{?>
													      <a class="gdlr-core-lightgallery gdlr-core-js " href="#"><img src="<?php echo base_url(); ?>course_images/<?php echo $ci["web_course_image"]?>" width="550" height="500"  alt="" /><span class="gdlr-core-image-overlay "><i class="gdlr-core-image-overlay-icon gdlr-core-size-22 fa fa-search"  ></i></span></a>
													<?php }?>
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-course-info-item gdlr-core-item-pdlr gdlr-core-item-pdb" style="padding-bottom: 45px ;">
                                                    <div class="gdlr-core-course-info-item-inner clearfix" style="color: #ffffff ;background-color: #9C425E ;">
