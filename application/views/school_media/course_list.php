  ...
  <?php $this->load->view('school_media/school_include/mobile-header');?>
    <div class="kingster-body-outer-wrapper ">
     ...
     <?php $this->load->view('school_media/school_include/header');?>
        ...
        <div class="kingster-page-title-wrap  kingster-style-medium kingster-left-align" style="background-image:url(<?php echo base_url(); ?>school_media/images/course_list.jpg)">
                                    ...
                                    <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                                        <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                               ...
                                               $dm=1;
														...
														if($dept_id==0){ 
													$departments=$this->home_model->get_department_by_institution(ARC_MEDIA_SCHOOL);
					...
					<?php }?>
								...
								foreach($course_list as $c){
									$en_course_id=base64_encode($c["web_course_id"]);
												?>
                                                    <div class="gdlr-core-course-item-list">
													<a class="gdlr-core-course-item-link" href="<?php echo base_url(); ?>school_media/course_search/course_details/0/<?php echo $cm;?>/<?php echo $en_course_id?>">
													<span class="gdlr-core-course-item-id gdlr-core-skin-caption" ><?php echo ucfirst($c["web_course_number"])?></span>
													<span class="gdlr-core-course-item-title gdlr-core-skin-title" ><?php echo ucfirst($c["web_course_name"])?></span>
												<!--	<span class="gdlr-core-course-item-title gdlr-core-skin-title" style="padding-left:20%" > <?php echo ucfirst($c["duration"])?>  </span>
													<span class="gdlr-core-course-item-title gdlr-core-skin-title"  style=" padding-left:20%" > <?php echo ucfirst($c["mode_of_training"])?>  </span>-->
                                ...
                                <div id="text-18" class="widget widget_text kingster-widget">
                                  ...
                                  <span style="font-size: 15px;"><br /> Prasanthi Towers,
                                        ...
                                        <br /> Kadappakada, Kerala 691001</span></p>
										  <p><span style="font-size: 15px;"><i class="fa fa-phone"> +91-799 422 1133</i><br/><a href="https://wa.me/919400441110" target="_blank" style="color:#fff"><i class="fa fa-whatsapp"> +91 940 044 1110</i></a><br /><i class="fa fa-envelope"> schoolofmedia@arcite.in</i><br /> </span></p>
