...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
     ...
     <?php $this->load->view('school_media/school_include/header');?>
            ...
            <div class="kingster-page-wrapper" id="kingster-page-wrapper">
                <div class="gdlr-core-page-builder-body">
                       <?php $this->load->view('school_media/school_include/home-slider');?>
                       <?php $this->load->view('school_media/school_include/home-placement');?>
                       <?php $this->load->view('school_media/school_include/home-aboutus');?>
                       <?php $this->load->view('school_media/school_include/home-videotour');?>
                       <?php $this->load->view('school_media/school_include/home-admission');?>
                       <?php $this->load->view('school_media/school_include/home-testimonials');?>
                       ...
                       <?php $this->load->view('school_media/school_include/home-events');?>
                       <?php $this->load->view('school_media/school_include/home-news');?>
                  ...
                  <?php $this->load->view('school_media/school_include/home-coursesearch');?>
                  <?php $this->load->view('school_media/school_include/home-newsletters');?>
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-gallery-item gdlr-core-item-pdb clearfix  gdlr-core-gallery-item-style-grid" style="padding-bottom: 0px ;">
                                        <div class="gdlr-core-gallery-item-holder gdlr-core-js-2 clearfix" data-layout="fitrows" >
                                            <div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-8 gdlr-core-column-first gdlr-core-item-pdlr gdlr-core-item-mgb">
                                                <div class="gdlr-core-gallery-list gdlr-core-media-image"><img src="<?php echo base_url(); ?>school_media/upload/1.png" alt="" width="150" height="120" title="banner-1" /></div>
                                            </div>
                                            <div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-8 gdlr-core-item-pdlr gdlr-core-item-mgb">
                                                <div class="gdlr-core-gallery-list gdlr-core-media-image"><img src="<?php echo base_url(); ?>school_media/upload/10.png" alt="" width="150" height="120" title="banner-2" /></div>
                                            </div>
                                            <div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-8 gdlr-core-item-pdlr gdlr-core-item-mgb">
                                                <div class="gdlr-core-gallery-list gdlr-core-media-image"><img src="<?php echo base_url(); ?>school_media/upload/11.png" alt="" width="150" height="120" title="banner-3" /></div>
                                            </div>
											 <div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-8 gdlr-core-item-pdlr gdlr-core-item-mgb">
                                                <div class="gdlr-core-gallery-list gdlr-core-media-image"><img src="<?php echo base_url(); ?>school_media/upload/2.png" alt="" width="150" height="120" title="banner-3" /></div>
                                            </div>
                                            <div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-8 gdlr-core-item-pdlr gdlr-core-item-mgb">
                                                <div class="gdlr-core-gallery-list gdlr-core-media-image"><img src="<?php echo base_url(); ?>school_media/upload/6.png" alt="" width="150" height="120" title="banner-4" /></div>
                                            </div>
                                            <div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-8 gdlr-core-item-pdlr gdlr-core-item-mgb">
                                                <div class="gdlr-core-gallery-list gdlr-core-media-image"><img src="<?php echo base_url(); ?>school_media/upload/4.png" alt="" width="150" height="120" title="banner-5" /></div>
                                            </div>
											 <div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-8 gdlr-core-item-pdlr gdlr-core-item-mgb">
                                                <div class="gdlr-core-gallery-list gdlr-core-media-image"><img src="<?php echo base_url(); ?>school_media/upload/9.png" alt="" width="150" height="120" title="banner-5" /></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
 ...
 <?php $this->load->view('school_media/school_include/scripts');?>
	...
	function() {       
	   jQuery(document).on("click", ".newsletter-save", function(e){
           ...
           // jQuery("form#news_letter").submit();
			...
			jQuery.ajax({
		url: "<?php echo base_url();?>school_media/home/save_newsletter",
		type: 'post',
