                ...
                <div class="gdlr-core-page-builder-body">
                    <div class="gdlr-core-pbf-wrapper " style="margin: 0px 0px 0px 0px;padding: 290px 0px 170px 0px;">
                        <div class="gdlr-core-pbf-background-wrap">
                            <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(<?php echo base_url(); ?>school_media/upload/get-in-touch.jpg) ;background-size: cover ;background-position: center ;" data-parallax-speed="0.3"></div>
                        </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-contact-form-7-item gdlr-core-item-pdlr gdlr-core-item-pdb ">
                                                    <div role="form" class="wpcf7" id="wpcf7-f1979-p1977-o1" lang="en-US" dir="ltr">
                                                        ...
                                                        <div class="screen-reader-response" style="color:#9C425E"><strong><i class="fa fa-thumbs-up"></i> Thank You For Your Feedback/ Queries. Will Respond to you Soon </strong></div>
														<br/>	<?php }
...
$this->session->unset_userdata('alert_status');
  ...
  ?>
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <div class="quform-submit">
                                                                        <div class="quform-submit-inner" >
                                                                            <button type="button" class="submit-button submit_feeback" style="background-color:#9C425E"><span>Send</span></button>
                                                                        </div>
                                                ...
                                                <div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix ">
                                                    <ul>
                                                        <li class=" gdlr-core-skin-divider gdlr-core-with-hover"><span class="gdlr-core-icon-list-icon-wrap"><i class="gdlr-core-icon-list-icon-hover fa fa-envelope-o" style="font-size: 16px ;"  ></i><i class="gdlr-core-icon-list-icon fa fa-envelope-o" style="font-size: 16px ;width: 16px ;" ></i></span>
                                                            <div class="gdlr-core-icon-list-content-wrap"><span class="gdlr-core-icon-list-content" style="font-size: 16px ;">schoolofmedia@arcite.in</span></div>
                                                        </li>
                                                        <li class=" gdlr-core-skin-divider gdlr-core-with-hover"><span class="gdlr-core-icon-list-icon-wrap"><i class="gdlr-core-icon-list-icon-hover fa fa-phone" style="font-size: 16px ;"  ></i><i class="gdlr-core-icon-list-icon fa fa-phone" style="font-size: 16px ;width: 16px ;" ></i></span>
                                                            <div class="gdlr-core-icon-list-content-wrap"><span class="gdlr-core-icon-list-content" style="font-size: 16px ;"> +91-799 422 1133</span></div>
                                                        </li>
														 <li class=" gdlr-core-skin-divider gdlr-core-with-hover"><span class="gdlr-core-icon-list-icon-wrap"><i class="gdlr-core-icon-list-icon-hover fa fa-whatsapp" style="font-size: 16px ;"  ></i><i class="gdlr-core-icon-list-icon fa fa-whatsapp" style="font-size: 16px ;width: 16px ;" ></i></span>
															...
															<a href="https://wa.me/919400441110" target="_blank" style="color:#6b6b6b;" >+91 940 044 1110</a></span></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    <iframe  style="width:100%; height:380px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15767.686541998415!2d76.5981729324971!3d8.886878090070768!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b05fda158dd943b%3A0x8e0edcd5df08ce54!2sARCITE%20SCHOOL%20OF%20MEDIA!5e0!3m2!1sen!2sin!4v1648532343960!5m2!1sen!2sin"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"width="600" height="350" style="border:0;"></iframe>
                    ...
                    <div class="gdlr-core-pbf-wrapper " style="padding: 75px 0px 75px 0px;">
                        ...
                        <div class="gdlr-core-pbf-wrapper-content gdlr-core-js " data-gdlr-animation="fadeInUp" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8">
                            <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-pbf-wrapper-full-no-space">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-social-network-item gdlr-core-item-pdb  gdlr-core-center-align gdlr-core-item-pdlr" style="padding-bottom: 0px ;"><a href="mailto:schoolofmedia@arcite.in" target="_blank" class="gdlr-core-social-network-icon" title="email" style="font-size: 20px ;color: #232323 ;"><i class="fa fa-envelope" ></i></a><a href="https://www.facebook.com/ArciteSchoolofMedia/" target="_blank" class="gdlr-core-social-network-icon" title="facebook" style="font-size: 20px ;color: #232323 ;margin-left: 37px ;"><i class="fa fa-facebook" ></i></a><a href="http://bit.ly/ArciteSchoolofMedia" target="_blank" class="gdlr-core-social-network-icon" title="google" style="font-size: 20px ;color: #232323 ;margin-left: 37px ;"><i class="fa fa-google" ></i></a>
									<a href="https://www.linkedin.com/in/arcite-media-school-4082921a2" target="_blank" class="gdlr-core-social-network-icon" title="linkedin" style="font-size: 20px ;color: #232323 ;margin-left: 37px ;"><i class="fa fa-linkedin" ></i></a>
									<a href="https://youtube.com/channel/UCI-rNXhrfPXlcOGIh52eUnA" target="_blank" class="gdlr-core-social-network-icon" title="skype" style="font-size: 20px ;color: #232323 ;margin-left: 37px ;"><i class="fa fa-youtube-play" ></i></a>
									<a href="https://twitter.com/arcite_of?s=08" target="_blank" class="gdlr-core-social-network-icon" title="twitter" style="font-size: 20px ;color: #232323 ;margin-left: 37px ;"><i class="fa fa-twitter" ></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	function() {       
	   jQuery(document).on("click", ".submit_feeback", function(e){
            ...
            jQuery('html,body').animate({
                    ...
                    'slow');
            return false;
        }else if (jQuery.trim($("#contact_email").val()) == "") {
					//alert("first");
            ...
            jQuery('html,body').animate({
                    ...
                    'slow');
            return false;
        }else if (jQuery.trim($("#feedback_message").val()) == "") {
					//alert("first");
			...
			jQuery("form#contact_form").attr("action", "<?=base_url()?>school_media/contact_us/save_feedback");
