                    ...
                    <div class="kingster-header-container-inner clearfix">
                        <div class="kingster-logo  kingster-item-pdlr">
                            <div class="kingster-logo-inner">
                                <a class="" href="<?php echo base_url(); ?>school_media/home"><img src="<?php echo base_url(); ?>school_media/images/arcite-media-black.png" alt="" /></a>
                            </div>
                        </div>
                        <div class="kingster-navigation kingster-item-pdlr clearfix ">
                            <div class="kingster-main-menu" id="kingster-main-menu">
                                <ul id="menu-main-navigation-1" class="sf-menu">
                                    <li class="menu-item menu-item-home  menu-item-has-children kingster-normal-menu <?php if($menu==1){ echo 'current-menu-item'; }?>">
									<a href="<?php echo base_url(); ?>school_media/home" class="sf-with-ul-pre">Home</a>
                                    </li>
                                  <!--  <li class="menu-item menu-item-has-children kingster-normal-menu"><a href="#" class="sf-with-ul-pre">Pages</a>
                                   ...
                                   <!-- <li class="menu-item menu-item-has-children kingster-normal-menu"><a href="apply-to-kingster.html" class="sf-with-ul-pre">Admissions</a>
                                    ...
                                    <li class="menu-item menu-item-has-children kingster-normal-menu <?php if($menu==2){ echo 'current-menu-item'; }?>"><a href="<?php echo base_url(); ?>school_media/course_search" class="sf-with-ul-pre">Courses</a>
                                        <ul class="sub-menu">
										<?php $dept=$this->home_model->get_department_by_institution(ARC_MEDIA_SCHOOL);
													$i=1;
													$j=1;
								foreach($dept as $dt);
								$crse_name="";
								...
								foreach($crse_list as $cs){
									...
									$en_course_id=base64_encode($cs["web_course_id"]);
									 if($cs["web_course_disp_mode"]==1){?>
                                            ...
                                            <li class="menu-item <?php if($course_menu==$j){ echo 'current-menu-item'; }?>" data-size="60">
											<a href="<?php echo base_url(); ?>school_media/course_search/course_details/<?php echo $i?>/<?php echo $j?>/<?php echo $en_course_id ?>"><?php echo $cs["web_course_name"];?></a></li>
									 <?php }else{?>	
                                            <li class="menu-item <?php if($course_menu==$j){ echo 'current-menu-item'; }?>" data-size="60">
											<a href="#"><?php echo $cs["web_course_name"];?></a></li>
									 <?php }
                                ...
                                <li class="menu-item kingster-normal-menu <?php if($menu==4){ echo 'current-menu-item'; }?>"><a href="<?php echo base_url(); ?>school_media/about_us">Who We Are</a></li>
                                    <!--<li class="menu-item kingster-normal-menu <?php if($menu==5){ echo 'current-menu-item'; }?>" ><a href="<?php echo base_url(); ?>school_media/gallery">Gallery</a></li>-->
                                   <!-- <li class="menu-item kingster-normal-menu <?php if($menu==6){ echo 'current-menu-item'; }?>" ><a href="<?php echo base_url(); ?>school_media/igbc_student_chapter">IGBC </a></li>-->
                                    <li class="menu-item kingster-normal-menu <?php if($menu==7){ echo 'current-menu-item'; }?>" ><a href="<?php echo base_url(); ?>school_media/contact_us">Contact Us</a></li>
