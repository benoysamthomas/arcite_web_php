            ...
            <div class="kingster-mobile-header-container kingster-container clearfix">
                <div class="kingster-logo  kingster-item-pdlr">
                    <div class="kingster-logo-inner">
                        <a class="" href="<?php echo base_url(); ?>school_media/home">
						<img src="<?php echo base_url(); ?>school_media/images/arcite-media-black.png" alt="" /></a>
                    </div>
                </div>
                <div class="kingster-mobile-menu-right">
                    <div class="kingster-main-menu-search" id=""><a href="<?php echo base_url(); ?>login" target="_blank"><i class="fa fa-sign-in"></i></a></div>
                    ...
                    <div class="kingster-mobile-menu"><a class="kingster-mm-menu-button kingster-mobile-menu-button kingster-mobile-button-hamburger" href="#kingster-mobile-menu"><span></span></a>
                        <div class="kingster-mm-menu-wrap kingster-navigation-font" id="kingster-mobile-menu" data-slide="right">
                            <ul id="menu-main-navigation" class="m-menu">
                                <li class="menu-item menu-item-home  <?php if($menu==1){ echo 'current-menu-item'; }?> menu-item-has-children"><a href="<?php echo base_url(); ?>school_media/home">Home</a>
                                </li>
                              ...
                              <!--  <li class="menu-item menu-item-has-children"><a href="bachelor-of-science-in-business-administration.html">Academics</a>
                               ...
                               <!-- <li class="menu-item menu-item-has-children"><a href="apply-to-kingster.html">Admissions</a>
                                ...
                                <li class="menu-item menu-item-has-children <?php if($menu==2){ echo 'current-menu-item'; }?>"><a href="<?php echo base_url(); ?>school_media/course_search">Courses</a>
                                    <ul class="sub-menu">
                             ...
                             <li class="menu-item <?php if($menu==4){ echo 'current-menu-item'; }?>"><a href="<?php echo base_url(); ?>school_media/about_us">Who We are</a></li>
                                <!--<li class="menu-item <?php if($menu==5){ echo 'current-menu-item'; }?>"><a href="<?php echo base_url(); ?>school_media/gallery">Gallery</a></li>-->
                               <!-- <li class="menu-item <?php if($menu==6){ echo 'current-menu-item'; }?>"><a href="<?php echo base_url(); ?>school_media/igbc_student_chapter">IGBC </a></li>-->
                                <li class="menu-item <?php if($menu==7){ echo 'current-menu-item'; }?>"><a href="<?php echo base_url(); ?>school_media/contact_us">Contact Us</a></li>
                                 </ul>
                        </div>
                    </div>
                </div>
