  ...
  <?php $this->load->view('school_media/school_include/mobile-header');?>
    <div class="kingster-body-outer-wrapper ">
     ...
     <?php $this->load->view('school_media/school_include/header');?>
            <div class="kingster-page-title-wrap  kingster-style-medium kingster-center-align" style="background-image:url(<?php echo base_url(); ?>school_media/upload/news_updates.jpg)">
                <div class="kingster-header-transparent-substitute"></div>
                <div class="kingster-page-title-overlay"></div>
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr">
                        <div class="kingster-page-caption"></div>
                        <h1 class="kingster-page-title" style="color:#9C425E;">News & Updates</h1></div>
                </div>
            </div>
                                    ...
                                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 0px 0px 100px 0px;">
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                           ...
                                           <div class="gdlr-core-blog-full-head-right">
                                                                ...
                                                                <div class="gdlr-core-blog-info-wrapper gdlr-core-skin-divider"  style="margin-left:10px;"><span class="gdlr-core-blog-info gdlr-core-blog-info-font gdlr-core-skin-caption gdlr-core-blog-info-date"><a href="#"><?php echo  date("d M, Y",strtotime($n1["web_news_date"]));?></a></span><span class="gdlr-core-blog-info gdlr-core-blog-info-font gdlr-core-skin-caption gdlr-core-blog-info-author"><span class="gdlr-core-head" ><?php echo $n1["news_category"]?></span>
