...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <?php $this->load->view('school_technical_edu/tech_include/topbar');?>
         ...
         <?php $this->load->view('school_technical_edu/tech_include/header');?>
            ...
            <div class="kingster-page-title-wrap  kingster-style-medium kingster-center-align"  style="background-image:url(<?php echo base_url(); ?>school_technical_edu/images/GALLERY.jpg)">
                <div class="kingster-header-transparent-substitute"></div>
                <div class="kingster-page-title-overlay"></div>
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr">
                        <div class="kingster-page-caption"></div>
                        <h1 class="kingster-page-title">Our Gallery</h1></div>
                </div>
            </div>
...
<?php if(!empty($main_gallery)){
	foreach($main_gallery as $g){
		
		$en_gallery_id=base64_encode($g["web_gallery_id"]);?>
                                            <div class="gdlr-core-item-list  gdlr-core-item-pdlr gdlr-core-item-mgb gdlr-core-column-15 ">
                                                <div class="gdlr-core-portfolio-metro">
                                                    <div class="gdlr-core-portfolio-thumbnail gdlr-core-media-image  gdlr-core-style-title-icon  gdlr-core-metro-rvpdlr">
														...
														<a href="<?php echo base_url(); ?>school_technical_edu/gallery/gallery_category_details/<?php echo $en_gallery_id; ?>" >
														<?php if($g["web_gallery_main_image"]!=""){?>
														<img src="<?php echo base_url();?>gallery_images/<?php echo $g["web_gallery_main_image"]?>" width="700" height="935"  alt="" /><span class="gdlr-core-image-overlay  gdlr-core-portfolio-overlay gdlr-core-image-overlay-center-icon gdlr-core-js">
														<?php } else{?>
													<img src="<?php echo base_url(); ?>school_technical_edu/upload/shutterstock_53600224-400x534.jpg" width="700" height="935"  alt="" />													<span class="gdlr-core-image-overlay  gdlr-core-portfolio-overlay gdlr-core-image-overlay-center-icon gdlr-core-js"><span class="gdlr-core-image-overlay-content" ><span class="gdlr-core-portfolio-title gdlr-core-title-font " style="font-size: 22px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;"  >
	
															
														<?php }?>
														<span class="gdlr-core-image-overlay-content" ><span class="gdlr-core-portfolio-title gdlr-core-title-font " style="font-size: 22px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;"  >
													<?php echo ucfirst($g["web_gallery_category_name"]);?></span><span class="gdlr-core-portfolio-icon-wrap"><a class="gdlr-core-lightgallery gdlr-core-js "  href="<?php echo base_url();?>gallery_images/<?php echo $g["web_gallery_main_image"]?>" data-lightbox-group="gdlr-core-img-group-1"><i class="gdlr-core-portfolio-icon arrow_expand" ></i>
														</a></span></span>
                                                            </span></a>
                                                        </div>
                                                    </div>
