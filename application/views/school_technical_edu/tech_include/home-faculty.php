                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-top gdlr-core-no-caption gdlr-core-item-pdlr" id="div_1dd7_32">
                                                    <div class="gdlr-core-column-service-media gdlr-core-media-image" id="div_1dd7_33"><img src="<?php echo base_url(); ?>school_technical_edu/upload/photo1.jpg" alt="" width="100" height="100" title="col-icon-1" style="border-radius:50%" /></div>
                                                    <div class="gdlr-core-column-service-content-wrapper">
                                                        <div class="gdlr-core-column-service-title-wrap">
                                                            <h3 class="gdlr-core-column-service-title gdlr-core-skin-title" id="h3_1dd7_6">John Smoith</h3></div>
                                                        <div class="gdlr-core-column-service-content" id="div_1dd7_34">
                                                            <p>Asst. Proffesor</p> 
															<a class="gdlr-core-column-service-read-more gdlr-core-info-font" href="#" id="a_1dd7_1">Learn More</a>
															</div>
                                                    </div>
                                                </div>
                                            </div>
