                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style="padding-bottom: 25px ;">
                                                    <div class="gdlr-core-title-item-title-wrap clearfix">
                                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 32px ;font-weight: 700 ;">Certificate Verification Report</h3></div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                                                ...
                                                                <div class="quform-element">
                                                                    <!--<p>
                                                                        ...
                                                                        <span class="wpcf7-form-control-wrap your-name">
                                                                          Registration No:
                                                                         <input type="text" name="registration_no" id="registration_no" size="20" class="input1" aria-required="true" aria-invalid="false" >
                                                                        </span> 
                                                                    </p>-->
																		<?php if(!empty($certificate_details)){
																			foreach($certificate_details as $c);?>
																	<table class="bordered">
																	<thead></thead>
																	<tbody style="text-align:left;">
																	<tr >
																	<td style=" padding-left:10px;"> <strong>Registration Number</strong></td>
																	<td  style=" padding-left:10px;"> <?php echo $c["web_cert_reg_id"];?></td>
																	</tr>
																	<tr>
																	<td style=" padding-left:10px;"> <strong>Student Name</strong></td>
																	<td style=" padding-left:10px;"> <?php echo ucfirst($c["web_cert_student_name"]);?></td>
																	</tr>
																	<tr>
																	<td style=" padding-left:10px;"> <strong>Course Name</strong></td>
																	<td style=" padding-left:10px;"> <?php echo ucfirst($c["web_course_name"]);?></td>
																	</tr>
																		<tr>
																	<td style=" padding-left:10px;"> <strong>Course Duration</strong></td>
																	<td style=" padding-left:10px;"> <?php echo $c["duration"];?></td>
																	</tr>
																		<tr>
																	<td style=" padding-left:10px;"> <strong>Issue Date</strong></td>
																	<td style=" padding-left:10px;"> <?php echo date("d/m/Y",strtotime($c["web_cert_issue_date"]));?></td>
																	</tr>
																			<tr>
																	<td style=" padding-left:10px;"> <strong>Result</strong></td>
																	<td style=" padding-left:10px;"> <?php if($c["web_cert_status"]==1){ echo "Passed";}else if($c["web_cert_status"]==2){ echo "Failed";} else if ($c["web_cert_status"]==3){ echo "Course Completed";}else { echo "Course Not Completed";}?></td>
																	</tr>
																	</tbody>
																	</table>
																		<?php } else{?>
																	...
																	<tr >
																	<td style=" padding-left:10px;"> <strong>No Records Found!</strong></td>
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <div class="quform-submit">
                                                                        <div class="quform-submit-inner">
                                                                            <a href="<?=base_url()?>school_technical_edu/certificate_verification"  class="submit-button" style="color:#fff;text-align:center;">Back</a>
                                                                        </div>
 ...
 jQuery(document).ready(
	function() {       
	   jQuery(document).on("click", ".submit-button", function(e){
			...
			jQuery("form#verification_form").attr("action", "<?=base_url()?>school_technical_edu/certificate_verification");
